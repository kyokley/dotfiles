...
then
    ...
    sudo apt-get purge gnome-screensaver -yq
    sudo apt-get install -yq zsh terminator fonts-inconsolata silversearcher-ag xscreensaver xscreensaver-screensaver-bsod direnv fonts-hack-ttf
fi
