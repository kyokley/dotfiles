  ...
  flake.modules = {
    ...
    homeManager.hyprland = {
      ...
      wayland.windowManager.hyprland = {
        ...
        # Load the monitors config generated by hyprmoncfgd (if any) so that
        # hyprmoncfg's include-chain verification passes and profiles apply on
        # hotplug/lid events.  pcall keeps this a no-op until hyprmoncfg has
        # written ~/.config/hypr/monitors.lua.  Hyprland does not add the config
        # directory to package.path, so it has to be done here.
        extraConfig = ''
